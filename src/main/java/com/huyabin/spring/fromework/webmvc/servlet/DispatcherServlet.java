package com.huyabin.spring.fromework.webmvc.servlet;
...
import com.huyabin.spring.fromework.context.GPApplicationContext;
import com.huyabin.spring.fromwork.webmvc.GPHandlerAdapter;
import com.huyabin.spring.fromwork.webmvc.GPHandlerMapping;
import com.huyabin.spring.fromwork.webmvc.GPModelAndView;
import com.huyabin.spring.fromwork.webmvc.GPViewResolver;
...
public class DispatcherServlet extends HttpServlet {
    ...
    private void initStrategies(GPApplicationContext context) {
        ...
        //直接解析请求到视图名
        initRequesToViewNameTranslator(context);
        /* 自己实现 */
    ...
    private void initThemResolver(GPApplicationContext context) { }

    /*
    * 将controller中配置的RequestMapping进行一一对应
    *
    *
    * */
    ...
    public GPHandlerMapping getHandler(HttpServletRequest req){
    ...
    private void initRequesToViewNameTranslator(GPApplicationContext context) {
    }
